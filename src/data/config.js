...
export const projects = [
  ...
  },
  {
    ...
    description: "Designed a 6-post carousel campaign for Six7 Studio, a premium menswear brand. Bold typography, dark cinematic aesthetics, and product storytelling.",
    imageKey: "six7Cover",
    span: "col-span-2",
  ...
  {
    id: 201,
    title: "Six7 — Made to Move",
    category: "Poster Design",
    description: "'Made to Move With You' — Dark launch poster for Six7 Studio featuring a hanger product shot and bold white/green typographic hierarchy.",
    imageKey: "six7Post01",
    span: "col-span-1",
    tags: ["Typography", "Poster", "Dark Theme"],
    year: "2025",
  },
  {
    id: 202,
    title: "Six7 — Quality You Feel",
    category: "Infographic Design",
    description: "'Quality You Feel. Style You Live.' — Light editorial post with folded tee stack showcasing Premium Fabric, Perfect Fit, Timeless Style attributes.",
    imageKey: "six7Post02",
    span: "col-span-1",
    tags: ["Editorial", "Minimal", "Fashion"],
    year: "2025",
  },
  {
    id: 203,
    title: "Six7 — Premium Details",
    category: "Campaign Design",
    description: "'Premium Details. Every Time.' — Dark cinematic post with T-shirt hanger hero and product close-up strip for Six7 Studio's quality narrative.",
    imageKey: "six7Post03",
    span: "col-span-1",
    tags: ["Cinematic", "Product", "Dark"],
    year: "2025",
  },
  {
    id: 204,
    title: "Six7 — Essential Today",
    category: "Collection Launch",
    description: "'Essential Today. Favorite Forever.' — Moody collection reveal post featuring 5 colorway T-shirts on rails with minimal iconography.",
    imageKey: "six7Post04",
    span: "col-span-1",
    tags: ["Collection", "Moody", "Launch"],
    year: "2025",
  },
];
